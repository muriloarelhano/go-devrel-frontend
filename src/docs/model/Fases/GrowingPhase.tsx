...
export const GrowingPhaseModelDoc: React.FC = () => {
  return (
    <>
      ...
      <Text>
        🎯 Objetivos: Fornecer impulso de ganho; Gerenciar mudança de
      ...
      <Text>
        🎯 Objetivos: Fornecer impulso de ganho; Gerenciar mudança de
        plataforma; Apoiar contribuições de nicho; Permitir que os
        desenvolvedores trabalhem com as mais recentes e melhores tecnologias do
